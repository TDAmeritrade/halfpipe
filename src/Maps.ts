...
export const keys = createInvoker<Map<any, any>>("keys") as <K, V>() => (
  map: Map<K, V>
) => K[];

export const values = createInvoker<Map<any, any>>("values") as <K, V>() => (
  map: Map<K, V>
) => V[];

export const entries = createInvoker<Map<any, any>>("entries") as <K, V>() => (
  map: Map<K, V>
) => [K, V][];

export const has = createInvoker<Map<any, any>>("has") as <K, V>(
  key: K
) => (map: Map<K, V>) => boolean;
